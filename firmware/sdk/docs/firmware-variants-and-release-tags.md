...
The project preserves four distinct recovery and development artifacts. They
...
| Performance | 0.3.3 | Hardware-validated TIM2/GPIO DMA, ADC DMA, two frame slots, legacy compatibility, and V2 streaming | Source and compiled hashes |
...
binary-identical to proprietary firmware. Reconstruction and performance images
have passed target hardware tests; the coordinator remains compile-only until
its own explicit flash authorization and validation.
